...
(function ($) {
	...
	Scene_Base.prototype.update = function() {
		...
		if (this.isMobileDevice() && this._aButton != undefined && this._cButton != undefined){
			var visible = Scene_Base.dirpad;
			this._aButton.visible = this._cButton.visible = visible;
			if(this._dirPad){
				this._dirPad.visible = visible;
			}
		}
	...
	Scene_Map.prototype.terminate = function() {
		if (this.isMobileDevice())
			...
			this._aButton.visible = this._cButton.visible = false;
